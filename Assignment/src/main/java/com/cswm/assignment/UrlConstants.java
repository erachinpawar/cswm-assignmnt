...
public class UrlConstants {
	...
	public static final  String  URL_ALL_ORDER_BOOKS="/orderbooks";
	public static final  String  URL_GET_ORDER_BOOK="/orderbooks/{orderBookId}";
	...
	public static final  String  URL_EXECUTE_ORDER_BOOK="/orderbooks/{orderBookId}/execute";
}
