...
public class Order {
	...
	@Value("${application.order.limit.order.price}")
	@Transient
	private static Double limitOrderPrice;
	...
	public Order(OrderBook orderBook, String createdBy, Date createdOn, Order order) {
		...
		if (OrderType.LIMIT_ORDER == order.orderType)
			this.orderprice = limitOrderPrice;
	}
	...
	/*
	 * public Order(OrderBuilder orderBuilder) { super(); this.orderId =
	 * orderBuilder.orderId; this.orderName = orderBuilder.orderName;
	 * this.instrument = orderBuilder.instrument; this.orderQuantity =
	 * orderBuilder.orderQuantity; this.orderprice = orderBuilder.orderprice;
	 * this.orderStatus = orderBuilder.orderStatus; this.orderType =
	 * orderBuilder.orderType; this.orderBook = orderBuilder.orderBook;
	 * this.executionQuantity = orderBuilder.executionQuantity; this.createdBy =
	 * orderBuilder.createdBy; this.createdOn = orderBuilder.createdOn; }
	 */
	...
	/*
	 * public class OrderBuilder { private Long orderId; private String orderName;
	 * private Instrument instrument; private Long orderQuantity; private Double
	 * orderprice; private OrderStatus orderStatus; private OrderType orderType;
	 * private OrderBook orderBook; private Double executionQuantity; private String
	 * createdBy; private Date createdOn;
	 * 
	 * 
	 * 
	 * public OrderBuilder(Order order) { super(); this.orderId = order.orderId;
	 * this.orderName =order. orderName; this.instrument = order.instrument;
	 * this.orderQuantity = order.orderQuantity; this.orderprice = order.orderprice;
	 * this.orderStatus = order.orderStatus; this.orderType = order.orderType;
	 * this.orderBook = order.orderBook; this.executionQuantity =
	 * order.executionQuantity; this.createdBy = order.createdBy; this.createdOn =
	 * order.createdOn; }
	 * 
	 ...
	 * 
	 * public void setOrderQuantity(Long orderQuantity) { this.orderQuantity =
	 * orderQuantity; }
	 * 
	 ...
	 * 
	 * public Double getExecutionQuantity() { return executionQuantity; }
	 * 
